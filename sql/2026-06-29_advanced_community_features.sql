...
('f0000000-0000-0000-0000-000000000001', 'ai', 'Open Source LLM Hackathon', 'Join members in building agents using LLaMA-3 and Mistral.', 'August 1 - 5, 2026', 'Virtual'),
('f0000000-0000-0000-0000-000000000002', 'ai', 'AI Safety Reading Group', 'A weekly discussion on AI alignment and safety research papers.', 'Every Friday', 'Discord');

insert into public.community_discussion_sections (id, community_slug, name, description) values
('e0000000-0000-0000-0000-000000000001', 'ai', 'Machine Learning', 'Discussions around classic ML, deep learning, and architectures.'),
('e0000000-0000-0000-0000-000000000002', 'ai', 'Generative AI', 'LLMs, Diffusion Models, and Prompt Engineering.'),
('e0000000-0000-0000-0000-000000000003', 'ai', 'Career & Mentorship', 'Advice on breaking into the AI field, interviews, and resumes.');

insert into public.community_discussions (id, section_id, mock_author_name, mock_author_title, title, content) values
('d0000000-0000-0000-0000-000000000001', 'e0000000-0000-0000-0000-000000000001', 'Eng. John Smith', 'ML Engineer', 'Batch Normalization vs Layer Normalization', 'When should I prefer LayerNorm over BatchNorm in CNNs? I know LN is standard in Transformers, but what about ResNets?'),
('d0000000-0000-0000-0000-000000000002', 'e0000000-0000-0000-0000-000000000002', 'Dr. Sarah Connor', 'AI Researcher', 'Best RAG Strategies for 2026', 'Are vector databases still the gold standard, or are folks moving towards graph-based retrieval?');
...
insert into public.community_discussion_sections (id, community_slug, name, description) values
('e0000000-0000-0000-0000-000000000010', 'data-science', 'Data Engineering', 'Pipelines, ETL/ELT, Airflow, and Data Warehousing.'),
('e0000000-0000-0000-0000-000000000011', 'data-science', 'Data Visualization', 'Tableau, PowerBI, D3.js and visual storytelling.');
