  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6 space-y-16" dir={isRtl ? "rtl" : "ltr"}>
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        <h1 className="text-4xl md:text-5xl font-bold text-slate-900">{t("about.title")}</h1>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <Card className="border-none shadow-md bg-white">
          <CardContent className="p-8 space-y-4 text-center">
            ...
            <p className="text-slate-600 leading-relaxed">{t("about.vision_desc")}</p>
          </CardContent>
        </Card>
        <Card className="border-none shadow-md bg-white">
          <CardContent className="p-8 space-y-4 text-center">
            ...
            <p className="text-slate-600 leading-relaxed">{t("about.mission_desc")}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="space-y-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-slate-900 mb-2">{t("about.leadership_title")}</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-2xl font-semibold">{t("about.advisory_board")}</h3>
            </div>
            <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center justify-center min-h-[200px]">
              <p className="text-slate-400">{t("about.advisory_coming_soon")}</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-2xl font-semibold">{t("about.executive_office")}</h3>
            </div>
            <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center justify-center min-h-[200px]">
              <p className="text-slate-400">{t("about.executive_coming_soon")}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-900 text-white p-12 rounded-3xl text-center space-y-6">
        ...
        <div className="aspect-video bg-slate-800 rounded-xl flex items-center justify-center border border-slate-700 max-w-4xl mx-auto">
          <p className="text-slate-500">{t("about.org_diagram_coming")}</p>
        </div>
      </div>
