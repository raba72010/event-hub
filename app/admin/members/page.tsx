...
export default function AdminMembersPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-slate-900">{t("admin.members_title")}</h1>
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm flex flex-col items-center justify-center py-24 text-slate-400">
        ...
        <h3 className="text-lg font-semibold text-slate-600">{t("admin.members_coming_soon")}</h3>
        <p className="text-sm mt-2 max-w-xs text-center">{t("admin.members_coming_soon_desc")}</p>
      </div>
    </div>
  )
}
